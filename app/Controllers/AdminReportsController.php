...
class AdminReportsController {
  ...
  public function index(){
    ...
    // KPIs
    $kpis = [
      'enrolls'=>0,'learners'=>0,'active_courses'=>0,'completion_rate'=>0.0
    ];
  ...
  public function export(){
    ...
    $pdo = DB::conn();
    [$from,$to,$range] = $this->parseRange();
    header('Content-Type: text/csv');
    header('Content-Disposition: attachment; filename="course_performance_'.$from.'_to_'.$to.'.csv"');
