    ...
    <form method="post" action="<?=app_url('signup')?>">
      ...
      <div style="display:flex;gap:12px;flex-wrap:wrap;">
        <label style="flex:1 1 240px;">Phone
          <input type="text" name="phone" value="<?=e($old['phone'] ?? '')?>" required pattern="[0-9+\-\s]{7,15}" title="7-15 characters: digits, spaces, + or - allowed" inputmode="tel" autocomplete="tel" />
          <small class="muted">Digits, spaces, + or - (7–15 characters)</small>
